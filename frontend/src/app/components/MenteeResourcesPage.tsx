        ...
        >
          <div>
            ...
            <p className="text-slate-600 text-lg">
              Browse mentor-assigned resources and complete exercises.
            </p>
          </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <button className="inline-flex items-center gap-2 px-5 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700">
                      ...
                      ) : resource.type.includes("Exercise") ? (
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            {exercises.map((exercise, index) => (
              ...
              >
                ...
                <button className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors font-medium">
                  {exercise.completed ? (
                    <>
