...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    private void seedAll() {
        ...
        e1a.setDescription(
                "Leading robotics integration projects, mentoring junior engineers on ROS and computer vision pipelines.");
        ...
        User m2 = createUser("Sarah Anderson", "sarah.anderson@encenter.ro", Role.MENTOR, "Senior Project Manager",
                "EnCenter Ltd.", 4.8, 22, 55);
        ...
        e2a.setDescription(
                "Managing a portfolio of 6 concurrent software projects with teams across Romania and Germany.");
        ...
        e2b.setDescription(
                "Delivered 15+ enterprise software projects using Agile methodologies for US-based clients.");
        ...
        e2c.setDescription(
                "Gathered requirements and coordinated delivery for ERP implementations across 3 industries.");
        ...
        // Mentor 3: Emma Blake
        User m3 = createUser("Emma Blake", "emma.blake@encenter.ro", Role.MENTOR, "HR Specialist", "EnCenter Ltd.", 4.7,
                14, 31);
        MentorProfile p3 = new MentorProfile();
        p3.setUser(m3);
        p3.setHourlyRate(0.0);
        p3.setProfileBio(
                "Dedicated to organizational psychology, employee growth, and building strong corporate cultures. I love helping people find their voice in the workplace.");
        ...
        e3b.setDescription(
                "Hired 200+ engineers annually, built employer branding campaigns that reduced time-to-hire by 30%.");
        ...
        // Mentor 4: David Kim
        User m4 = createUser("David Kim", "david.kim@encenter.ro", Role.MENTOR, "Lead Software Architect",
                "EnCenter Ltd.", 4.9, 27, 68);
        MentorProfile p4 = new MentorProfile();
        p4.setUser(m4);
        p4.setHourlyRate(0.0);
        p4.setProfileBio(
                "Full-stack developer with a deep love for Spring Boot, PostgreSQL, and clean architecture. 12 years building enterprise systems means I've made every mistake so you don't have to.");
        ...
        e4a.setDescription(
                "Defining technical strategy and architecture standards across 4 product engineering teams.");
        ...
        User m5 = createUser("Elena Popescu", "elena.popescu@encenter.ro", Role.MENTOR, "Principal Data Scientist",
                "EnCenter Ltd.", 4.8, 19, 47);
        MentorProfile p5 = new MentorProfile();
        p5.setUser(m5);
        p5.setHourlyRate(0.0);
        p5.setProfileBio(
                "Turning raw data into actionable business intelligence. Love discussing algorithms and statistical models over coffee. I mentor on Python, ML pipelines, and breaking into data science.");
        p5.setExperienceSummary("8 years in predictive modeling and big data analytics.");
        p5.setSkills(Arrays.asList("Data Analysis", "Python", "Machine Learning", "Data Visualization", "Statistics",
                "SQL"));
        ...
        User u1 = createUser("Alex Ionescu", "alex.ionescu@encenter.ro", Role.MENTEE, "Junior Engineer",
                "EnCenter Ltd.", 0, 0, 0);
        ...
        mp1.setGoals(
                Arrays.asList("Understand AI tools", "Improve presentation skills", "Learn project management basics"));
        menteeProfileRepository.save(mp1);

        User u2 = createUser("Mihai Stan", "mihai.stan@encenter.ro", Role.MENTEE, "QA Tester", "EnCenter Ltd.", 0, 0,
                0);
        ...
        User u3 = createUser("Maria Radu", "maria.radu@encenter.ro", Role.MENTEE, "Marketing Associate",
                "EnCenter Ltd.", 0, 0, 0);
        ...
        User u5 = createUser("Laura Vasile", "laura.vasile@encenter.ro", Role.MENTEE, "Mid-level Developer",
                "EnCenter Ltd.", 0, 0, 0);
        ...
        saveSessionAndReview(p1, u1, "Introduction to Robot Vision", LocalDate.of(2026, 3, 10), LocalTime.of(10, 0), 60,
                5, "Ana was incredibly clear and patient. I finally understand how vision systems work!");
        saveSessionAndReview(p1, u2, "ROS Fundamentals", LocalDate.of(2026, 3, 24), LocalTime.of(14, 0), 60, 5,
                "Best technical mentor I've had. She maps complex topics to real examples perfectly.");
        saveSessionAndReview(p1, u4, "AI Tools Overview", LocalDate.of(2026, 4, 1), LocalTime.of(10, 0), 45, 4,
                "Very informative session. Would love to go deeper next time.");

        saveSessionAndReview(p2, u1, "Agile Kickoff Planning", LocalDate.of(2026, 3, 15), LocalTime.of(9, 0), 45, 5,
                "Sarah gave me a complete framework for running sprint planning. Immediately applied it.");
        saveSessionAndReview(p2, u3, "Stakeholder Communication", LocalDate.of(2026, 3, 28), LocalTime.of(14, 0), 60, 5,
                "Practical, direct, and genuinely helpful. Highly recommend.");
        saveSessionAndReview(p2, u5, "Risk Management Basics", LocalDate.of(2026, 4, 4), LocalTime.of(16, 0), 60, 4,
                "Great session. Sarah has a real-world story for every concept.");

        saveSessionAndReview(p3, u4, "Interview Prep", LocalDate.of(2026, 3, 18), LocalTime.of(10, 0), 45, 5,
                "Emma helped me completely reframe how I present myself. Got the job offer the next week!");
        saveSessionAndReview(p3, u1, "Public Speaking Confidence", LocalDate.of(2026, 4, 2), LocalTime.of(13, 0), 45, 5,
                "Structured, warm, and encouraging. Emma is amazing.");

        saveSessionAndReview(p4, u2, "Spring Boot Architecture Deep Dive", LocalDate.of(2026, 3, 20),
                LocalTime.of(17, 0), 90, 5,
                "David's knowledge of architecture patterns is unmatched. Worth 10 tutorials.");
        saveSessionAndReview(p4, u5, "System Design Interview Prep", LocalDate.of(2026, 4, 3), LocalTime.of(17, 0), 60,
                5, "Incredibly thorough. David walks through every trade-off clearly.");
        saveSessionAndReview(p4, u1, "REST API Best Practices", LocalDate.of(2026, 4, 7), LocalTime.of(15, 0), 60, 4,
                "Solid session with lots of practical code examples.");

        saveSessionAndReview(p5, u3, "Intro to Data Analysis with Python", LocalDate.of(2026, 3, 22),
                LocalTime.of(11, 0), 60, 5,
                "Elena made pandas and matplotlib click for me after months of struggling.");
        saveSessionAndReview(p5, u1, "ML Model Evaluation", LocalDate.of(2026, 4, 5), LocalTime.of(10, 0), 60, 5,
                "Exceptional mentor. She connected every concept to a business use case.");
        saveSessionAndReview(p5, u4, "Breaking into Data Science", LocalDate.of(2026, 4, 8), LocalTime.of(15, 0), 45, 5,
                "Elena gave me a concrete roadmap. Finally feel like I have a plan.");

        // Upcoming confirmed sessions
        saveUpcomingSession(p1, u1, "Advanced Vision Pipeline", LocalDate.of(2026, 5, 27), LocalTime.of(10, 0), 60);
        saveUpcomingSession(p2, u1, "Sprint Retrospective Techniques", LocalDate.of(2026, 5, 29), LocalTime.of(9, 0),
                45);
